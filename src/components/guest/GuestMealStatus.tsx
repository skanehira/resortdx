      ...
      return (
        <div className={`${iconClass} text-[var(--kincha)]`}>
          <svg viewBox="0 0 64 64" fill="currentColor">
            ...
            <rect x="30" y="12" width="4" height="10" transform="rotate(45 32 36)" />
            <rect x="30" y="12" width="4" height="10" transform="rotate(90 32 36)" />
            <rect x="30" y="12" width="4" height="10" transform="rotate(135 32 36)" />
      ...
      return (
        <div className={`${iconClass} text-[var(--aotake)]`}>
          <svg viewBox="0 0 64 64" fill="currentColor">
            ...
            <path d="M8 48 C8 28 56 28 56 48" fill="none" stroke="currentColor" strokeWidth="4" />
...
const RequestConfirmation = ({ requestedTime }: { requestedTime: string }) => (
  <div className="bg-[var(--aotake)]/10 border-2 border-[var(--aotake)] rounded-2xl p-6 text-center">
    <div className="flex items-center justify-center gap-3 mb-2">
      ...
      <span className="text-xl font-bold text-[var(--aotake)]">リクエストを受け付けました</span>
    </div>
...
export const GuestMealStatus = ({ taskId }: GuestMealStatusProps) => {
  ...
  useEffect(() => {
    const loadTask = () => {
      ...
      const mealTask = taskId ? getMealTaskById(taskId) : getMealTaskById("MEAL001"); // デモ用デフォルト
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl p-8 shadow-lg text-center max-w-md">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">お食事情報が見つかりません</h2>
    ...
    <div className={`min-h-screen bg-gradient-to-b ${getBackground()} pb-safe`}>
      ...
      <main className="max-w-lg mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
          ...
          <p className="text-lg text-gray-600">{COURSE_TYPE_LABELS[task.courseType]}コース</p>
        ...
        {!isCompleted && (
          <div className="space-y-3">
            <DetailCard
              ...
              subValue={`${getRoomName(task.roomId)}へご準備いたします`}
            />
        ...
        {task.dietaryRestrictions.length > 0 && !isCompleted && (
          <div className="bg-white rounded-2xl p-5 shadow-lg">
            ...
            {task.dietaryNotes && <p className="text-sm text-gray-600 mt-2">{task.dietaryNotes}</p>}
            <p className="text-xs text-gray-500 mt-3">上記の食材を除いたお料理をご用意いたします</p>
          </div>
        )}
        ...
        {/* リクエスト送信完了 */}
        {requestedTime && !isCompleted && <RequestConfirmation requestedTime={requestedTime} />}
        ...
        {isCompleted && (
          <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">お食事のご準備が整いました</h3>
            <p className="text-gray-600">
              ごゆっくりお召し上がりください。
              <br />
              ご不明な点がございましたら
        ...
        {!isCompleted && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
            ...
            <ul className="text-sm text-amber-700 space-y-1">
              ...
              <li>・ アレルギーや食事制限の変更はスタッフまでお申し付けください</li>
