...
export const AirConditionerIcon = ({ size = 20, className = "" }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const NotificationBadgeIcon = ({ size = 20, className = "" }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const InspectionIcon = ({ size = 20, className = "" }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    className={className}
  >
    {/* Inspection/magnifying glass with checkmark */}
    <circle cx="11" cy="11" r="8" />
    <path d="M21 21l-4.35-4.35" />
...
export const SwipeIcon = ({ size = 20, className = "" }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
