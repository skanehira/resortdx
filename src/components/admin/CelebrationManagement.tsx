...
import { mockCelebrationTasks, mockStaff, getStaffById } from "../../data/mockData";
import {
  CelebrationIcon,
  ClockIcon,
  AlertIcon,
    ...
    >
      ...
      <div className="mb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-medium text-[var(--sumi)]">{task.roomNumber}号室</span>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-[var(--shironeri-warm)] p-4 flex items-center justify-between">
          <h3 className="font-display font-semibold text-lg text-[var(--sumi)]">お祝い詳細</h3>
          <button
            onClick={onClose}
...
const CreateCelebrationModal = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.guestName || !formData.roomNumber || !formData.executionTime) {
      return;
    }
