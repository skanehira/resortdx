    ...
    >
      <div className="flex items-start justify-between mb-3">
        ...
        <div className="flex gap-1">
          ...
          <button
            onClick={onDelete}
            className="btn btn-ghost p-2 text-[var(--shu)] hover:bg-[rgba(199,62,58,0.1)]"
            aria-label="削除"
          >
            <TrashIcon size={16} />
          </button>
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      >
        <div className="space-y-4">
          <p className="text-[var(--sumi-light)]">「{templateToDelete?.name}」を削除しますか？</p>
          <p className="text-sm text-[var(--nezumi)]">この操作は取り消せません。</p>
          <div className="flex justify-end gap-3 pt-4">
            ...
            <button
              ...
              className="btn bg-[var(--shu)] text-white hover:bg-[#b03530]"
            >
              削除
            </button>
          </div>
