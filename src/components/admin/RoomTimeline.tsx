...
import { mockReservations, mockTasks, getStaffById, getTimeSlots } from "../../data/mockData";
    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          <span className="font-display font-medium text-[var(--sumi)]">{roomNumber}</span>
    ...
    <div className="shoji-panel animate-slide-in-right">
      <div className="p-4 border-b border-[rgba(45,41,38,0.08)] flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-display font-medium text-[var(--sumi)]">{roomNumber}号室</h3>
          {reservation?.anniversary && (
