...
import { TASK_CATEGORY_LABELS, type Task, type TaskStatus, type TaskCategory } from "../../types";
import { TaskIcon, CelebrationIcon, AlertIcon, SearchIcon, PlusIcon } from "../ui/Icons";
...
const CreateTaskModal = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={t("taskManagement.createTask")} size="lg">
      <form onSubmit={handleSubmit} className="space-y-4">
        {/* Category and Title */}
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-[var(--nezumi)] mb-1">
              {t("taskDetail.category")} <span className="text-[var(--shu)]">*</span>
            </label>
            <select
          ...
          <div>
            <label className="block text-sm text-[var(--nezumi)] mb-1">
              {t("priority.normal")} <span className="text-[var(--shu)]">*</span>
            </label>
            <select
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-[var(--nezumi)] mb-1">
              {t("taskDetail.room")} <span className="text-[var(--shu)]">*</span>
            </label>
            <select
          ...
          <div>
            <label className="block text-sm text-[var(--nezumi)] mb-1">予約</label>
            <select
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-[var(--nezumi)] mb-1">
              {t("taskDetail.scheduledTime")} <span className="text-[var(--shu)]">*</span>
            </label>
            <input
              type="time"
        ...
        <div>
          ...
          <StaffSelector
            ...
            onChange={(staffId) => setFormData({ ...formData, assignedStaffId: staffId ?? "" })}
            showUnassigned
            ariaLabel="担当者を選択"
          />
        </div>
        ...
        <div>
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-sm text-[var(--sumi)]">{t("taskDetail.anniversaryRelated")}</span>
